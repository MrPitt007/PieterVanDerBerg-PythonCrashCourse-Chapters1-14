...
print("Length of pi_string:", len(pi_string))   # 32 for 30 decimals including '3.'
 ...
 Large files: One million digits (same logic, different file)
 If the file is present, we process it; otherwise we skip gracefully.
 The official resource often names it 'pi_million_digits.txt'.
